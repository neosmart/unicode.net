...
namespace NeoSmart.Unicode
{
    ...
    {
        /// <summary>
        /// A (sorted) enumeration of all emoji without skin variations and no duplicate gendered vs gender-neutral emoji
        /// </summary>
        public static IEnumerable<SingleEmoji> Basic => All.Where(e => !SkinTones.All.Any(tone => e.Sequence.Contains(tone)));
